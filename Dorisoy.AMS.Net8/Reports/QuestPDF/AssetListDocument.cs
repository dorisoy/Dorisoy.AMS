        ...
        private void ComposeTable(IContainer container)
        {
            container.Table(table =>
            {
                ...
                table.Header(header =>
                {
                    ...
                    header.Cell().Element(HeaderCellStyle).Text("数量").FontSize(9).Bold().FontColor(Colors.White);
                    header.Cell().Element(HeaderCellStyle).Text("单位").FontSize(9).Bold().FontColor(Colors.White);
                    header.Cell().Element(HeaderCellStyle).Text("存放地点").FontSize(9).Bold().FontColor(Colors.White);
                    header.Cell().Element(HeaderCellStyle).Text("部门").FontSize(9).Bold().FontColor(Colors.White);
                    header.Cell().Element(HeaderCellStyle).Text("使用人").FontSize(9).Bold().FontColor(Colors.White);
